...
release = version = pre_commit_hooks.__version__
...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/pre-commit-hooks",
...
htmlhelp_basename = "pre_commit_hooksdoc"
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(pre_commit_hooks.__file__).parent)
    # fmt: on

    return f"https://github.com/{github_username}/pre-commit-hooks/blob/{html_context['github_version']}/src/pre_commit_hooks/{fn}{linespec}"
